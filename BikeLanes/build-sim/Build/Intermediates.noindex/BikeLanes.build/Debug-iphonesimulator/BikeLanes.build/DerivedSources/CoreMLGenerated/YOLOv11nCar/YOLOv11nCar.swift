...
class YOLOv11nCarInput : MLFeatureProvider {
...
@available(macOS 12.0, iOS 15.0, tvOS 15.0, watchOS 8.0, visionOS 1.0, *)
class YOLOv11nCarOutput : MLFeatureProvider {
...
class YOLOv11nCar {
    ...
    class var urlOfModelInThisBundle : URL {
        ...
        return bundle.url(forResource: "YOLOv11nCar", withExtension:"mlmodelc")!
    }

    /**
        Construct YOLOv11nCar instance with an existing MLModel object.

        Usually the application does not use this initializer unless it makes a subclass of YOLOv11nCar.
        Such application may want to use `MLModel(contentsOfURL:configuration:)` and `YOLOv11nCar.urlOfModelInThisBundle` to create a MLModel object to pass-in.
    ...
    */
    ...
    /**
        Construct YOLOv11nCar instance with explicit path to mlmodelc file
        - parameters:
    ...
    */
    ...
    /**
        Construct YOLOv11nCar instance asynchronously with optional configuration.
    ...
    */
    class func load(configuration: MLModelConfiguration = MLModelConfiguration(), completionHandler handler: @escaping (Swift.Result<YOLOv11nCar, any Error>) -> Void) {
    ...
    /**
        ...
        - parameters:
          - configuration: the desired model configuration
    */
    class func load(configuration: MLModelConfiguration = MLModelConfiguration()) async throws -> YOLOv11nCar {
        try await load(contentsOf: self.urlOfModelInThisBundle, configuration: configuration)
    }

    /**
        Construct YOLOv11nCar instance asynchronously with URL of the .mlmodelc directory with optional configuration.
        ...
        - parameters:
          ...
          - handler: the completion handler to be called when the model loading completes successfully or unsuccessfully
    */
    class func load(contentsOf modelURL: URL, configuration: MLModelConfiguration = MLModelConfiguration(), completionHandler handler: @escaping (Swift.Result<YOLOv11nCar, any Error>) -> Void) {
        MLModel.load(contentsOf: modelURL, configuration: configuration) { result in
            switch result {
            case .failure(let error):
                handler(.failure(error))
            case .success(let model):
                handler(.success(YOLOv11nCar(model: model)))
            }
        }
    }
    ...
    /**
        ...
        - parameters:
          ...
          - configuration: the desired model configuration
    */
    class func load(contentsOf modelURL: URL, configuration: MLModelConfiguration = MLModelConfiguration()) async throws -> YOLOv11nCar {
        let model = try await MLModel.load(contentsOf: modelURL, configuration: configuration)
        return YOLOv11nCar(model: model)
    }
    ...
    /**
        ...
        - parameters:
           - input: the input to the prediction as YOLOv11nCarInput

        - throws: an NSError object that describes the problem

        - returns: the result of the prediction as YOLOv11nCarOutput
    */
    func prediction(input: YOLOv11nCarInput) throws -> YOLOv11nCarOutput {
    ...
    /**
        ...
        - returns: the result of the prediction as YOLOv11nCarOutput
    */
    func prediction(input: YOLOv11nCarInput, options: MLPredictionOptions) throws -> YOLOv11nCarOutput {
        let outFeatures = try model.prediction(from: input, options: options)
        return YOLOv11nCarOutput(features: outFeatures)
    }
    ...
    */
    ...
    func prediction(input: YOLOv11nCarInput, options: MLPredictionOptions = MLPredictionOptions()) async throws -> YOLOv11nCarOutput {
    ...
    /**
        ...
        - returns: the result of the prediction as YOLOv11nCarOutput
    */
    func prediction(image: CVPixelBuffer, iouThreshold: Double, confidenceThreshold: Double) throws -> YOLOv11nCarOutput {
        let input_ = YOLOv11nCarInput(image: image, iouThreshold: iouThreshold, confidenceThreshold: confidenceThreshold)
    ...
    /**
        ...
        - parameters:
           - inputs: the inputs to the prediction as [YOLOv11nCarInput]
           - options: prediction options
        ...
        - returns: the result of the prediction as [YOLOv11nCarOutput]
    */
    func predictions(inputs: [YOLOv11nCarInput], options: MLPredictionOptions = MLPredictionOptions()) throws -> [YOLOv11nCarOutput] {
        let batchIn = MLArrayBatchProvider(array: inputs)
        let batchOut = try model.predictions(from: batchIn, options: options)
        var results : [YOLOv11nCarOutput] = []
        results.reserveCapacity(inputs.count)
        for i in 0..<batchOut.count {
            let outProvider = batchOut.features(at: i)
            let result =  YOLOv11nCarOutput(features: outProvider)
